...
public class PermitManager {
	...
	public String getCarLicense(String license) {

		for (ParkingPermit permit : permits) {
			if (permit.getCar().getLicensePlate() == license) {
				System.out.println("License already registered to: " + permit.getCar().getOwner().toString());
				break;
			} else {
				return license;
			}
